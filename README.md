...
https://github.com/user-attachments/assets/ba530c1a-a35e-4900-b4df-0bc851d4baaf
...
```bash
git clone https://github.com/SumukhShrote/Drone_Racing-Physical-Intelligence
```
